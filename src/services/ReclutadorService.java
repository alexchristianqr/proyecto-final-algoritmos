...
public class ReclutadorService extends BaseService {
    ...
    public DefaultTableModel tablaReclutadores(DefaultTableModel modelo, Object[] data) {
        ...
        ResultSet res = db.queryConsultar(querySQL_1);
    ...
    public List<Reclutador> listarReclutadores() {
        ...
        querySQL_2 = "SELECT p.id_persona, p.nombre, p.apellido, p.tipo_documento, p.nrodocumento, p.sexo, p.estado, p.edad, p.telefono, r.id_usuario, r.fecha_creado FROM personas p JOIN reclutadores r ON p.id_persona = r.id_persona;";
        ResultSet res = db.queryConsultar(querySQL_2);
